      ...
      <div className={S.ContainerForm}>
        <section className={S.FirstGrid}>
          <div className={S.ItemGrid}>
            ...
            <input type="text" {...register("name", { required: true })} className={S.InputForm} />
          </div>
          ...
          <div className={S.LastItemFirstGrid}>
            <label className={S.Title}>Descrição / Motivo de Reembolso</label>
            <input
              type="text"
              {...register("motivo")}
              className={S.InputForm}
        ...
        <section className={S.SecondGrid}>
          <div className={S.ItemGrid}>
            ...
            <input type="date" {...register("date")} className={S.InputForm} />
          </div>

          <div className={S.ItemGrid}>
            <label className={S.Title}>Tipo de Despesa</label>
            <select {...register("selection_despesa")} className={S.InputForm}>
          ...
          <div className={S.ItemGrid}>
            ...
            <select {...register("selection_custo")} className={S.InputForm}>
              <option value="0">Selecionar</option>
          ...
          <div className={S.LastItemFirstGrid}>
            <div className={S.BoxContainerGrid}>
              ...
              <div className={S.BoxButton}>
                ...
                <button className={S.ButtonDeleting} onClick={handleClearForm}>
      ...
      <table className={S.Table}>
        ...
        <tbody>
          {data.map((item, index) => (
            <tr key={index}>
              <td>
                <button className={S.IconButtonDelete} onClick={() => handleDelete(index)}>
                  <img src={IconBin} />
                </button>{" "}
